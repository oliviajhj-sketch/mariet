...
const WORD_SETS = {
    ...
    food: ['비프스테이크', '포크스테이크', '크림파스타', '디너코스', '런치코스', '브런치', '당근', '샐러드', '디저트'],
    hobby: ['대련', '연극연습', '악기연습', '음악', '합주', '친교활동'],
    study: ['수학', '언어', '문학', '철학', '천문학', '역사', '제왕학'],
    topic: ['후보자', '경연', '날씨', '취미', '과거', '미래', '고민', '시련'],
    book: ['만화책', '잡지', '소설책', '에세이'],
    destination: ['0지구', '1지구', '2지구', '3지구', '4지구', '5지구', '6지구', '7지구', '왕성', '대저택', '유적']
};
...
const ACTIONS = [
    ...
    { id: 'work', name: '업무', place: 'company', text: ['보고서를 작성했다', '회의에 참석했다', '서무업무를 했다', '티타임을 가졌다'] },
